...
* **DynamoDB table**: If you are using the [S3 backend](https://www.terraform.io/docs/backends/types/s3.html) for
  ...
  locking](https://www.terraform.io/docs/backends/types/s3.html#dynamodb_table)) parameter (formerly [`lock_table`](https://www.terraform.io/docs/backends/types/s3.html#lock_table)) in `remote_state.config`, if that table
