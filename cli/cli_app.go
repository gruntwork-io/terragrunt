...
const OPT_TERRAGRUNT_AUTO_APPLY_EXTERNAL_DEPENDENCIES = "terragrunt-auto-apply-external-dependencies"
...
var ALL_TERRAGRUNT_BOOLEAN_OPTS = []string{OPT_NON_INTERACTIVE, OPT_TERRAGRUNT_SOURCE_UPDATE, OPT_TERRAGRUNT_IGNORE_DEPENDENCY_ERRORS, OPT_TERRAGRUNT_IGNORE_EXTERNAL_DEPENDENCIES, OPT_TERRAGRUNT_AUTO_APPLY_EXTERNAL_DEPENDENCIES, OPT_TERRAGRUNT_NO_AUTO_INIT, OPT_TERRAGRUNT_NO_AUTO_RETRY, OPT_TERRAGRUNT_CHECK}
...
GLOBAL OPTIONS:
   ...
   terragrunt-auto-apply-external-dependencies  *-all commands will include external dependencies
