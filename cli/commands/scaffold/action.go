...
// github.com/gruntwork-io/terragrunt.git//test/inputs => git::https://github.com/gruntwork-io/terragrunt.git//test/inputs
func rewriteModuleUrl(opts *options.TerragruntOptions, vars map[string]interface{}, moduleUrl string) (*url.URL, error) {
	...
	// git::https://github.com/gruntwork-io/terragrunt.git//test/inputs => git::ssh://git@github.com/gruntwork-io/terragrunt.git//test/inputs
...
func addRefToModuleUrl(ctx context.Context, opts *options.TerragruntOptions, parsedModuleUrl *url.URL, vars map[string]interface{}) (*url.URL, error) {
	...
	if ref == "" {
		...
		// git::https://github.com/gruntwork-io/terragrunt.git//test/inputs => git::https://github.com/gruntwork-io/terragrunt.git//test/inputs?ref=v0.53.8
