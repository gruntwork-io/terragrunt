...
func TestPathRelativeToInclude(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			nil,
			options.TerragruntOptions{TerragruntConfigPath: helpers.RootFolder + "child/terraform.tfvars", NonInteractive: true},
			".",
		},
		{
			&IncludeConfig{Path: "../terraform.tfvars"},
			options.TerragruntOptions{TerragruntConfigPath: helpers.RootFolder + "child/terraform.tfvars", NonInteractive: true},
			"child",
		},
		{
			&IncludeConfig{Path: helpers.RootFolder + "terraform.tfvars"},
			options.TerragruntOptions{TerragruntConfigPath: helpers.RootFolder + "child/terraform.tfvars", NonInteractive: true},
			"child",
		},
		{
			&IncludeConfig{Path: "../../../terraform.tfvars"},
			options.TerragruntOptions{TerragruntConfigPath: helpers.RootFolder + "child/sub-child/sub-sub-child/terraform.tfvars", NonInteractive: true},
		...
		{
			&IncludeConfig{Path: "../../other-child/terraform.tfvars"},
			options.TerragruntOptions{TerragruntConfigPath: helpers.RootFolder + "child/sub-child/terraform.tfvars", NonInteractive: true},
			"../child/sub-child",
		},
		{
			&IncludeConfig{Path: "../../terraform.tfvars"},
			options.TerragruntOptions{TerragruntConfigPath: "../child/sub-child/terraform.tfvars", NonInteractive: true},
			"child/sub-child",
		},
		{
			&IncludeConfig{Path: "${find_in_parent_folders()}"},
			options.TerragruntOptions{TerragruntConfigPath: "../test/fixture-parent-folders/terragrunt-in-root/child/sub-child/terraform.tfvars", NonInteractive: true},
			"child/sub-child",
		},
	}
...
func TestFindInParentFolders(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			options.TerragruntOptions{TerragruntConfigPath: "../test/fixture-parent-folders/terragrunt-in-root/child/terraform.tfvars", NonInteractive: true},
			"../terraform.tfvars",
			nil,
		},
		{
			options.TerragruntOptions{TerragruntConfigPath: "../test/fixture-parent-folders/terragrunt-in-root/child/sub-child/sub-sub-child/terraform.tfvars", NonInteractive: true},
			"../../../terraform.tfvars",
			nil,
		},
		{
			options.TerragruntOptions{TerragruntConfigPath: "../test/fixture-parent-folders/no-terragrunt-in-root/child/sub-child/terraform.tfvars", NonInteractive: true},
			"",
			ParentTerragruntConfigNotFound("../test/fixture-parent-folders/no-terragrunt-in-root/child/sub-child/terraform.tfvars"),
		},
		{
			options.TerragruntOptions{TerragruntConfigPath: "../test/fixture-parent-folders/multiple-terragrunt-in-parents/child/terraform.tfvars", NonInteractive: true},
			"../terraform.tfvars",
			nil,
		},
		{
			options.TerragruntOptions{TerragruntConfigPath: "../test/fixture-parent-folders/multiple-terragrunt-in-parents/child/sub-child/terraform.tfvars", NonInteractive: true},
			"../terraform.tfvars",
			nil,
		},
		{
			options.TerragruntOptions{TerragruntConfigPath: "../test/fixture-parent-folders/multiple-terragrunt-in-parents/child/sub-child/sub-sub-child/terraform.tfvars", NonInteractive: true},
			"../terraform.tfvars",
			nil,
		},
		{
...
func TestResolveTerragruntInterpolation(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			nil,
			options.TerragruntOptions{TerragruntConfigPath: "/root/child/terraform.tfvars", NonInteractive: true},
			".",
			nil,
		},
		{
	...
	testCases := []struct {
		...
		},
		{
			...
			options.TerragruntOptions{
				TerragruntConfigPath: "/root/child/terraform.tfvars",
				NonInteractive: true,
