...
func TestFindInParentFolders(t *testing.T) {
	...
	tc := []struct {
		...
		{
			nil,
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/terragrunt-in-root/child/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/terragrunt-in-root/"+config.DefaultTerragruntConfigPath),
			nil,
		},
		{
			nil,
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/terragrunt-in-root/child/sub-child/sub-sub-child/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/terragrunt-in-root/"+config.DefaultTerragruntConfigPath),
			nil,
		},
		{
			nil,
			terragruntOptionsForTestWithMaxFolders(t, "../test/fixtures/fixture-parent-folders/no-terragrunt-in-root/child/sub-child/"+config.DefaultTerragruntConfigPath, 3),
			"",
			config.ParentFileNotFoundError{},
		},
		{
			nil,
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/multiple-terragrunt-in-parents/child/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/multiple-terragrunt-in-parents/"+config.DefaultTerragruntConfigPath),
			nil,
		},
		{
			nil,
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/multiple-terragrunt-in-parents/child/sub-child/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/multiple-terragrunt-in-parents/child/"+config.DefaultTerragruntConfigPath),
			nil,
		},
		{
			nil,
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/multiple-terragrunt-in-parents/child/sub-child/sub-sub-child/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/multiple-terragrunt-in-parents/child/sub-child/"+config.DefaultTerragruntConfigPath),
			nil,
		},
		{
			[]string{"foo.txt"},
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/other-file-names/child/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/other-file-names/foo.txt"),
			nil,
		},
		{
			[]string{"common/foo.txt"},
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/in-another-subfolder/live/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/in-another-subfolder/common/foo.txt"),
			nil,
		},
		{
			[]string{"tfwork"},
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/with-params/tfwork/tg/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/with-params/tfwork"),
			nil,
		},
		{
			nil,
...
func TestResolveTerragruntInterpolation(t *testing.T) {
	...
	tc := []struct {
		...
		},
		{
			...
			nil,
			terragruntOptionsForTest(t, "../test/fixtures/fixture-parent-folders/terragrunt-in-root/child/sub-child/"+config.DefaultTerragruntConfigPath),
			absPath(t, "../test/fixtures/fixture-parent-folders/terragrunt-in-root/"+config.DefaultTerragruntConfigPath),
			"",
		},
		{
			"terraform { source = find_in_parent_folders() }",
			nil,
			terragruntOptionsForTestWithMaxFolders(t, "../test/fixtures/fixture-parent-folders/terragrunt-in-root/child/sub-child/"+config.DefaultTerragruntConfigPath, 1),
			"",
...
func TestTerraformBuiltInFunctions(t *testing.T) {
	...
	for _, tt := range tc {
		...
		t.Run(tt.input, func(t *testing.T) {
			...
			terragruntOptions := terragruntOptionsForTest(t, "../test/fixtures/fixture-config-terraform-functions/"+config.DefaultTerragruntConfigPath)
...
func TestReadTerragruntConfigInputs(t *testing.T) {
	...
	tgConfigCty, err := config.ParseTerragruntConfig(ctx, "../test/fixtures/fixture-inputs/terragrunt.hcl", nil)
	require.NoError(t, err)
...
func TestReadTerragruntConfigHooks(t *testing.T) {
	...
	options := terragruntOptionsForTest(t, config.DefaultTerragruntConfigPath)
	ctx := config.NewParsingContext(context.Background(), options)
	tgConfigCty, err := config.ParseTerragruntConfig(ctx, "../test/fixtures/fixture-hooks/before-after-and-on-error/terragrunt.hcl", nil)
	require.NoError(t, err)
...
func TestReadTerragruntConfigLocals(t *testing.T) {
	...
	options := terragruntOptionsForTest(t, config.DefaultTerragruntConfigPath)
	ctx := config.NewParsingContext(context.Background(), options)
	tgConfigCty, err := config.ParseTerragruntConfig(ctx, "../test/fixtures/fixture-locals/canonical/terragrunt.hcl", nil)
	require.NoError(t, err)
...
func TestReadTFVarsFiles(t *testing.T) {
	...
	options := terragruntOptionsForTest(t, config.DefaultTerragruntConfigPath)
	ctx := config.NewParsingContext(context.Background(), options)
	tgConfigCty, err := config.ParseTerragruntConfig(ctx, "../test/fixtures/fixture-read-tf-vars/terragrunt.hcl", nil)
	require.NoError(t, err)
