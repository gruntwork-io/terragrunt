...
![Using Terragrunt to promote immutable Infrastructure as Code across environments](/img/collections/documentation/promote-immutable-Terraform-code-across-envs.png)
