...
:::note[Windows Users]
This script is for Unix-like systems (Linux/macOS). Windows users should use the PowerShell snippet in the Convenience Scripts section below, or install via [Chocolatey](https://chocolatey.org/).
:::
