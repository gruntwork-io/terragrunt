...
**Note**: Not all blocks are able to access outputs passed by `dependency` blocks. See the section on [Configuration parsing order](/docs/reference/hcl/overview#configuration-parsing-order) for more information.
