...
As covered in [Units](/docs/features/units) and [State Backend](/docs/features/state-backend),
...
To solve this, you can use [multiple include blocks](/docs/reference/config-blocks-and-attributes#include).
