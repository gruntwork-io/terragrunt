...
{/*
    ...
    Once you have d2 installed, you can uncomment the diagram above, update the `astro.config.mjs` file to uncomment
    the d2 plugin, edit it, and see it change live,
    then commit the updated diagram to the repo.
*/}

![Example DAG](../../../assets/img/d2/docs/02-features/05-run-queue-0.svg)
