...
{/* TODO: Write a script to fetch the latest version of the engine. See ../../../../TODO.md */}
...
engine {
  source  = "https://github.com/gruntwork-io/terragrunt-engine-opentofu/releases/download/v0.0.7/terragrunt-iac-engine-opentofu_rpc_v0.0.7_linux_amd64.zip"
}
...
engine {
   source  = "/home/users/iac-engines/terragrunt-iac-engine-opentofu_v0.0.7"
}
```
