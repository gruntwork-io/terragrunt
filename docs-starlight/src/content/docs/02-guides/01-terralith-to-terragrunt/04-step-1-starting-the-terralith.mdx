...
To get started, we'll want to define our [providers](https://opentofu.org/language/providers/), which is how OpenTofu will actually effectuate infrastructure in AWS.
