...
**DEPRECATED: Use [exclude](/docs/configuration/configuration-blocks#exclude) instead.**
...
**DEPRECATED: Use [errors](/docs/configuration/configuration-blocks#errors) instead.**
