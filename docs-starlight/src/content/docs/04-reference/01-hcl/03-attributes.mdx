...
mechanism](https://opentofu.org/language/values/variables/#environment-variables). This means that each input
...
constraint](https://opentofu.org/language/values/variables/#type-constraints) on the variable in OpenTofu/Terraform in
...
- CircleCI: [Using OpenID Connect tokens in jobs](https://circleci.com/openid-connect-tokens/)
