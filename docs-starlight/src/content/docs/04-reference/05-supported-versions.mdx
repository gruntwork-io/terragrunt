...
|----------------------------------------|----------------|
| `/api/v1/compatibility/index.json`     | All entries    |
| `/api/v1/compatibility/opentofu.json`  | OpenTofu only  |
| `/api/v1/compatibility/terraform.json` | Terraform only |

**Example:**

```bash
curl https://terragrunt.gruntwork.io/api/v1/compatibility/opentofu.json
```
