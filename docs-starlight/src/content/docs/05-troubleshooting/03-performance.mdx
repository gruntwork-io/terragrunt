...
You can mitigate this performance penalty by using the `skip-dependency-inputs` strict control. For more information about strict controls, refer to the [Strict Mode documentation](/docs/reference/strict-mode).
