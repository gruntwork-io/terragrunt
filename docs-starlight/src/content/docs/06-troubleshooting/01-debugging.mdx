...
Now you'll want to do whatever you want to trace with Terrragrunt by running Terragrunt normally.
...
For example, you could use it like this to debug an `plan` that's producing unexpected outcomes:
