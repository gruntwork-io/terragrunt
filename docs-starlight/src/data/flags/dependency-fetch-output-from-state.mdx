...
The limitation of this approach is that it is only supported by S3 and GCS backends, and OpenTofu/Terraform may change the schema of the state file in the future, breaking this functionality.
