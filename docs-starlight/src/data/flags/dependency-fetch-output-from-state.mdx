...
The limitation of this approach is that it is only supported by the S3 and Azure Storage backends, and OpenTofu/Terraform may change the schema of the state file in the future, breaking this functionality.
