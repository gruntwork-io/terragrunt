...
For more information about Git-based filtering and advanced usage patterns, see the [Filters feature documentation](/docs/features/filter#git-based-filtering).
