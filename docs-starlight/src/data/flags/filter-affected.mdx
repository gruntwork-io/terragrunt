...
For more information about Git-based filtering and advanced usage patterns, see the [Filters feature documentation](/features/filter#git-based-expressions).
