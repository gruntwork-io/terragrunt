...
For more details and examples, see the [Filters feature documentation](/features/filter#git-based-expressions).
...
For more detailed examples and explanations, see the [Filters feature documentation](/features/filter#graph-based-expressions).
</Aside>
