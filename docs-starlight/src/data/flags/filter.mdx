...
For more details and examples, see the [Filters feature documentation](/docs/features/filter/git).
...
For more detailed examples and explanations, see the [Filters feature documentation](/docs/features/filter/graph).
</Aside>
