...
1. Identify all units with files named `error-signals.json`.
2. Checkout the previous commit for those units.
3. Apply the units in their previous state, effectively reverting their updates.  
