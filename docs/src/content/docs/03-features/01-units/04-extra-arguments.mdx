...
Note that you're encouraged to use the [Provider Caching](/features/caching/provider-cache-server) feature instead of manually installing plugins in most cases.
