...
See the [`autoinclude` block reference](/reference/hcl/blocks#autoinclude) for the full contract: what an autoinclude body may contain, how the merge works, stack-level autoincludes, and depending on entire stacks.
