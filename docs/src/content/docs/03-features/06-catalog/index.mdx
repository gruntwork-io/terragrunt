...
An organization can also register catalog repositories in the Gruntwork Developer Portal.

After `terragrunt --experiment tg-login login`, `terragrunt --experiment tg-login catalog` will automatically discover repositories selected in the Gruntwork Developer Portal as part of your catalog.

<PortalCatalogBeta campaign="catalog-overview" />
