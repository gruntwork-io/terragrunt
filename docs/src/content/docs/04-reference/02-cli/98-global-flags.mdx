...
The `--profile-cpu` flag ships with v1.1.1.
...
The `--profile-dir` flag ships with v1.1.1.
...
The `--profile-goroutine` flag ships with v1.1.1.
...
The `--profile-mem` flag ships with v1.1.1.
