...
- The relative path is computed from the directory where you invoked Terragrunt (the root working directory).
...
|----------|-------------|
| `TG_EXPERIMENT=profiling` | Enables the profiling experiment for env-var based profiling. |
