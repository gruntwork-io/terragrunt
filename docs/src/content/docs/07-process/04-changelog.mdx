...
{/* Add new entries at the top of the changelog. Use the following format:
...
This page tracks notable changes to Terragrunt. For the full list of releases and their assets, see the [GitHub Releases Page](https://github.com/gruntwork-io/terragrunt/releases).
...
To learn more, read the [documentation on the integration with tflint](/features/hooks/#tflint-hook).
...
This functionality is better served by a combination of [`find`](/reference/cli/commands/find/) and [graph-based filters](/features/filter/#graph-based-expressions).
...
For all prior releases, see the [GitHub Releases Page](https://github.com/gruntwork-io/terragrunt/releases).
