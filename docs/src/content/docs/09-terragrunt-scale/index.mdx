...
- **[Pipelines](/terragrunt-scale/pipelines)** — CI/CD for for Terragrunt, built by the creators. Plan on PR/MR, apply on merge, with blast radius minimization and OIDC authentication.
