...
Previously gated behind the `oci` experiment, these sources no longer require `--experiment oci`. See [OCI registries](/features/units/oci) for the publishing contract and the full authentication order.
