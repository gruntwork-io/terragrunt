...
- [x] End-to-end live coverage against a real subscription for container bootstrap, blob versioning convergence, and backend delete, behind the `azure_integration` build tag. Hermetic unit tests ship behind the `azure` build tag.
