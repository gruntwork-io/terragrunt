...
Enables usage of [Terragrunt IaC engines](/features/units/engine) for running IaC operations. This allows Terragrunt to use pluggable engines to execute OpenTofu/Terraform commands, providing enhanced functionality and extensibility.
