...
- [ ] `terragrunt run --all` discovery walks generated nested stack files when they contain terragrunt function calls in unit `source`/`path`
...
- [x] `terragrunt run --all` discovery walks generated nested stack files when they contain terragrunt function calls in unit `source`/`path`
