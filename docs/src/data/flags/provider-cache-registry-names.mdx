...
Specifies which provider registries should be cached by the Provider Cache server. This flag is only used when the [Provider Cache Server](/features/provider-cache-server) is enabled.
