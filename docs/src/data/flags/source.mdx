---
name: source
description: Download OpenTofu/Terraform configurations from the specified source into a temporary folder, and run OpenTofu/Terraform in that temporary folder.
type: string
env:
  - TG_SOURCE
---
