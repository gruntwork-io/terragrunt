...
replace (
	...
	// github.com/charmbracelet/x/ansi@v0.9.2 has a messed up checksum, so we pin back to v0.9.1
	github.com/charmbracelet/x/ansi => github.com/charmbracelet/x/ansi v0.9.1
