...
// unrelatedModel is a tea.Model that is not a tui.Model, used to verify
...
func TestEmitExitMessage_WritesMessageToErrWriter(t *testing.T) {
	...
	m := tui.NewModelWithExitMessageForTest("values stub written to foo")

	tui.EmitExitMessage(m, &buf, logger.CreateLogger())
...
func TestEmitExitMessage_NoMessageWritesNothing(t *testing.T) {
	...
	tui.EmitExitMessage(tui.NewModelWithExitMessageForTest(""), &buf, logger.CreateLogger())
...
func TestEmitExitMessage_UnrelatedModelIsNoop(t *testing.T) {
	...
	tui.EmitExitMessage(unrelatedModel{}, &buf, logger.CreateLogger())
...
func TestEmitExitMessage_WriteFailureIsLogged(t *testing.T) {
	...
	m := tui.NewModelWithExitMessageForTest("anything")

	assert.NotPanics(t, func() {
		tui.EmitExitMessage(m, failingWriter{}, logger.CreateLogger())
	})
}
...
func TestWelcomeLoadingScreen_TransitionsToComponentListWithRacing(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		withComponentsLoad := func(
			_ context.Context,
			_ tui.StatusFunc,
			componentCh chan<- *tui.ComponentEntry,
		) error {
		...
		m := tui.NewWelcomeModel(t.Context(), l, opts, withComponentsLoad)
...
func TestWelcomeLoadingScreen_QuitDuringLoadingWithRacing(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		slowLoad := func(ctx context.Context, _ tui.StatusFunc, _ chan<- *tui.ComponentEntry) error {
			select {
