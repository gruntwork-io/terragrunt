...
const (
	...
	// CapabilityEnv lets tool calls see the server's environment variables.
...
var allCapabilities = []Capability{CapabilityExec, CapabilityHTTP, CapabilitySops, CapabilityEnv}
