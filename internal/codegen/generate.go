...
const (
	...
	ExistsOverwriteTerragruntOrSkip
	ExistsUnknown
)
...
const (
	...
	ExistsOverwriteTerragruntOrSkipStr = "overwrite_terragrunt_or_skip"
...
func shouldContinueWithFileExists(
	...
	case ExistsOverwriteTerragrunt:
		...
		return true, nil
	case ExistsOverwriteTerragruntOrSkip:
		// Same as overwrite_terragrunt, except that a file terragrunt did not generate is left
		...
		if !wasGenerated {
			l.Debugf("The file path %s already exists and was not generated by terragrunt."+
				" Since if_exists for code generation is set to"+
				" \"overwrite_terragrunt_or_skip\", will not regenerate file.", path)
		...
		l.Debugf("The file path %s already exists, but was a previously generated"+
			" file by terragrunt. Since if_exists for code generation is set to"+
			" \"overwrite_terragrunt_or_skip\", regenerating file.", path)
...
func GenerateConfigExistsFromString(val string) (GenerateConfigExists, error) {
	...
	case ExistsOverwriteTerragruntOrSkipStr:
		return ExistsOverwriteTerragruntOrSkip, nil
	}
