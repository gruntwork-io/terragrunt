...
func downloadEngine(ctx context.Context, l log.Logger, v *venv.Venv, execOptions *ExecutionOptions) error {
...
func lastReleaseVersion(ctx context.Context, c vhttp.Client, opts *ExecutionOptions) (string, error) {
