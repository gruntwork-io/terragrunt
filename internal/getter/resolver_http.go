...
func NewHTTPResolver() *HTTPResolver {
	return &HTTPResolver{scheme: SchemeHTTP, Client: vhttp.NewOSClientWithTimeout(httpResolverTimeout)}
}
...
func NewHTTPSResolver() *HTTPResolver {
	return &HTTPResolver{scheme: SchemeHTTPS, Client: vhttp.NewOSClientWithTimeout(httpResolverTimeout)}
}
