...
func TestWriteJSONWithDiscoveryWorkingDir(t *testing.T) {
	...
	// Compare in slash form because nameOfPath returns OS-native separators.
	assert.Equal(t, "module/unit", filepath.ToSlash(runs[0].Name), "Run name should be relative to DiscoveryWorkingDir, not report.workingDir")
}
...
func TestWriteCSVWithDiscoveryWorkingDir(t *testing.T) {
	...
	// Compare in slash form because nameOfPath returns OS-native separators.
	assert.Equal(t, "module/unit", filepath.ToSlash(records[1][0]), "Run name should be relative to DiscoveryWorkingDir, not report.workingDir")
}
