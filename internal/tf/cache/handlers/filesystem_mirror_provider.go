...
func NewFilesystemMirrorProviderHandler(l log.Logger, c vhttp.Client, method *cliconfig.ProviderInstallationFilesystemMirror) *FilesystemMirrorProviderHandler {
