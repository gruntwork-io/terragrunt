...
func NewProxyModuleHandler(l log.Logger, c vhttp.Client, credsSource *cliconfig.CredentialsSource, discoverer RegistryURLDiscoverer, registryNames []string) *ProxyModuleHandler {
