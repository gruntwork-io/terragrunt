...
func (val *genericType[T]) Set(str string) error {
	...
	case *bool:
		...
		if err != nil {
			return errors.Errorf(`must be one of: "0", "1", "f", "t", "false", "true"`)
		}
	...
	case *int:
		...
		if err != nil {
			return errors.Errorf("must be 32-bit integer")
		}
	...
	case *uint:
		...
		if err != nil {
			return errors.Errorf("must be 32-bit unsigned integer")
		}
	...
	case *int64:
		...
		if err != nil {
			return errors.Errorf("must be 64-bit integer")
		}
