...
// State defines configurations for OpenTofu/Terraform remote state.
...
type RemoteStateInitializer interface {
	...
	NeedsInitialization(remoteState *State, existingBackend *TerraformBackend, terragruntOptions *options.TerragruntOptions) (bool, error)

	// Initialize the remote state
	Initialize(ctx context.Context, remoteState *State, terragruntOptions *options.TerragruntOptions) error
...
func (remoteState *State) FillDefaults() {
	// Nothing to do
}
...
func (remoteState *State) Initialize(ctx context.Context, terragruntOptions *options.TerragruntOptions) error {
...
func (remoteState *State) NeedsInit(terragruntOptions *options.TerragruntOptions) (bool, error) {
...
func (remoteState *State) DiffersFrom(existingBackend *TerraformBackend, terragruntOptions *options.TerragruntOptions) bool {
...
func (remoteState *State) GenerateTerraformCode(terragruntOptions *options.TerragruntOptions) error {
	if remoteState.Generate == nil {
