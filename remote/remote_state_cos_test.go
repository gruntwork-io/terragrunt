...
func TestCOSConfigValuesEqual(t *testing.T) {
	t.Parallel()
	...
	testCases := []struct {
	...
	}{
		{
			...
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{}},
			true,
		},
		{
			"equal-empty-and-nil",
		...
		},
		{
			...
			map[string]interface{}{},
			&TerraformBackend{Type: "cos"},
			true,
		},
		{
			"equal-one-key",
			map[string]interface{}{"foo": "bar"},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"foo": "bar"}},
			true,
		},
		{
			"equal-multiple-keys",
			map[string]interface{}{"foo": "bar", "baz": []string{"a", "b", "c"}, "blah": 123, "bool": true},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"foo": "bar", "baz": []string{"a", "b", "c"}, "blah": 123, "bool": true}},
			true,
		},
		{
			"equal-encrypt-bool-handling",
			map[string]interface{}{"encrypt": true},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"encrypt": "true"}},
			true,
		},
		{
			"equal-general-bool-handling",
			map[string]interface{}{"something": true, "encrypt": true},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"something": "true", "encrypt": "true"}},
			true,
		},
		{
			"equal-ignore-cos-labels",
			map[string]interface{}{"foo": "bar", "cos_bucket_labels": []map[string]string{{"foo": "bar"}}},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"foo": "bar"}},
			true,
		},
		{
		...
		},
		{
			"unequal-values",
			map[string]interface{}{"foo": "bar"},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"foo": "different"}},
			false,
		},
		{
		...
		},
		{
			...
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"something": "false"}},
			false,
		},
		{
			"equal-null-ignored",
			map[string]interface{}{"something": "foo"},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"something": "foo", "ignored-because-null": nil}},
			true,
		},
		{
			"terragrunt-only-configs-remain-intact",
			map[string]interface{}{"something": "foo", "skip_bucket_creation": true},
			&TerraformBackend{Type: "cos", Config: map[string]interface{}{"something": "foo"}},
			true,
		},
	}
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			...
			actual := cosConfigValuesEqual(config, testCase.backend, terragruntOptions)
