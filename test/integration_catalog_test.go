...
func TestCatalogGitRepoUpdate(t *testing.T) {
	...
	_, err := module.NewRepo(ctx, logger.CreateLogger(), "github.com/gruntwork-io/terraform-fake-modules.git", tempDir, false, false, false, "")
...
func TestScaffoldGitRepo(t *testing.T) {
	...
	repo, err := module.NewRepo(ctx, logger.CreateLogger(), "github.com/gruntwork-io/terraform-fake-modules.git", tempDir, false, false, false, "")
	require.NoError(t, err)
...
func TestScaffoldGitModule(t *testing.T) {
	...
	repo, err := module.NewRepo(ctx, logger.CreateLogger(), "https://github.com/gruntwork-io/terraform-fake-modules.git", tempDir, false, false, false, "")
	require.NoError(t, err)
...
func TestScaffoldGitModuleHttps(t *testing.T) {
	...
	repo, err := module.NewRepo(ctx, logger.CreateLogger(), "https://github.com/gruntwork-io/terraform-fake-modules", tempDir, false, false, false, "")
	require.NoError(t, err)
