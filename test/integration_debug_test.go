...
const (
	...
	fixtureMultiIncludeDependency = "fixtures/fixture-multiinclude-dependency"
	fixtureRenderJSON             = "fixtures/fixture-render-json"
	fixtureRenderJSONRegression   = "fixtures/fixture-render-json-regression"
)
...
func TestTerragruntValidateInputs(t *testing.T) {
	...
	moduleDirs, err := filepath.Glob(filepath.Join("fixtures/fixture-validate-inputs", "*"))
	require.NoError(t, err)
...
func TestTerragruntValidateInputsWithCLIVars(t *testing.T) {
	...
	moduleDir := filepath.Join("fixtures/fixture-validate-inputs", "fail-no-inputs")
...
func TestTerragruntValidateInputsWithCLIVarFile(t *testing.T) {
	...
	moduleDir := filepath.Join("fixtures/fixture-validate-inputs", "fail-no-inputs")
	args := []string{fmt.Sprintf("-var-file=%s/fixtures/fixture-validate-inputs/success-var-file/varfiles/main.tfvars", curdir)}
	runTerragruntValidateInputs(t, moduleDir, args, true)
}
...
func TestTerragruntValidateInputsWithStrictModeEnabledAndUnusedInputs(t *testing.T) {
	...
	moduleDir := filepath.Join("fixtures/fixture-validate-inputs", "fail-unused-inputs")
