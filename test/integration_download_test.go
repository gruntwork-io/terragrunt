...
func TestExcludeDirsWithFilter(t *testing.T) {
	...
	t.Skip("Skipping `TestExcludeDirsWithFilter` for now, because we need to update the logic in Runner Pool to not expect top-level results from discovery when they aren't needed.")
