...
func TestTFTerragruntReport(t *testing.T) {
	t.Parallel()
...
func TestTFTerragruntReportSaveToFileWithFormat(t *testing.T) {
	t.Parallel()
...
func TestTFTerragruntReportWithUnitTiming(t *testing.T) {
	t.Parallel()
...
// TestTFTerragruntReportWithGitFilter tests that report generation works correctly
...
func TestTFTerragruntReportWithGitFilter(t *testing.T) {
	t.Parallel()
...
// TestTFTerragruntReportSingleUnit tests that report generation works correctly
// for single unit runs (not --all). This verifies the fix that adds report
// generation support to single `terragrunt run` commands.
func TestTFTerragruntReportSingleUnit(t *testing.T) {
	t.Parallel()
